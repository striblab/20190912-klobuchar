...
```html
<div data-pym-src="https://static.startribune.com/news/projects/all/20190912-klobuchar">Loading...</div>
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/20190912-klobuchar/",
      "url": "http://static.startribune.com/news/projects-staging/all/20190912-klobuchar/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/20190912-klobuchar/",
      "url": "http://static.startribune.com/news/projects/all/20190912-klobuchar/"
    }
  }
}
```
